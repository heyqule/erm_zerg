...
function ErmZerg.make_devourer(level)
    ...
    local buildable_entities = ERM_UnitHelper.get_buildable_entities(ERM_ZERG.MOD_NAME, {
        "sunken_colony", "spore_colony", "greater_spire", "spire", "nyduspit",
    }, level)
    ...
    data:extend({
                    ...
                    action = {
                        {
                            ...
                            action_delivery = {
                                ...
                                source_effects = {
                                    type = "script",
                                    effect_id = ERM_ZERG.SCOURGE_SPAWN,
                                }
                            }
                        },
                        {
                            ...
                            action_delivery = {
                                type = "stream",
                                stream = ERM_ZERG.MOD_NAME .. "--" .. name .. "-stream-" .. level,
                            }
                        }
                    }
                },
        ...
        {
            type = "stream",
            name = ERM_ZERG.MOD_NAME .. "--" .. name .. "-stream-" .. level,
            flags = { "not-on-map" },
                        ...
                        target_effects = {
                            {
                                ...
                                entity_name = ERM_ZERG.MOD_NAME .. "--devourer-cloud-" .. level
                            },
                            {
                                type = "create-explosion",
                                entity_name = ERM_ZERG.MOD_NAME.."--devourer-cloud-explosion"
                            },
                            {
                                type = "play-sound",
        ...
        {
            name = ERM_ZERG.MOD_NAME .. "--devourer-cloud-" .. level,
