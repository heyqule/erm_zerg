...
data:extend{
    ...
    },
    {
        ...
        expression = "sqrt(var('control:enemy-base:size')) * (15 + 4 * erm_zerg_base_intensity)"
    },
    {
        type = "noise-expression",
        name = "erm_zerg_base_frequency",
        -- bases_per_km2 = 10 + 3 * erm_zerg_base_intensity
        expression = "(0.00001 + 0.000003 * erm_zerg_base_intensity) * var('control:enemy-base:frequency')"
    },
    {
        type = "noise-expression",
