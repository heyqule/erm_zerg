...
-- Resistance target for end-game spawners is 45-55%
...
local spawn_table = function(level)
    ...
    res[2] = { ERM_ZERG.MOD_NAME .. "--hydralisk--" .. level, { { 0.0, 0.3 }, { 0.2, 0.45 }, { 0.4, 0.3 }, { 0.6, 0.2 }, { 0.8, 0.2 }, {1.0, 0.05} } }
    res[3] = { ERM_ZERG.MOD_NAME .. "--mutalisk--" .. level, { { 0.0, 0.0 }, { 0.2, 0.1 }, { 0.4, 0.3 }, { 0.6, 0.1 }, { 0.8, 0.15 }, {1.0, 0.05} } }
    --Tire 2
