...
local max_count_of_owned_units = 100
local max_friends_around_to_spawn = 80
local spawn_table = function(level)
    ...
    --Tire 2
    res[4] = {MOD_NAME.."-lurker-"..level, {    {0.0, 0.0}, {0.2, 0.0}, {0.4, 0.1}, {0.6, 0.2},  {0.8, 0.0}}}
    res[5] = {MOD_NAME.."-guardian-"..level, {  {0.0, 0.0}, {0.2, 0.0}, {0.4, 0.1}, {0.6, 0.15}, {0.8, 0.15}}}
    res[6] = {MOD_NAME.."-devourer-"..level, {  {0.0, 0.0}, {0.2, 0.0}, {0.4, 0.1}, {0.6, 0.2},  {0.8, 0.0}}}
    res[7] = {MOD_NAME.."-overlord-"..level, {  {0.0, 0.0}, {0.2, 0.0}, {0.4, 0.1}, {0.6, 0.15}, {0.8, 0.3}}}
    --Tier 3
    res[8] = {MOD_NAME.."-drone-"..level, {     {0.0, 0.0}, {0.2, 0.0}, {0.4, 0},   {0.6, 0},  {0.8, 0.25}}}
    res[9] = {MOD_NAME.."-ultralisk-"..level, { {0.0, 0.0}, {0.2, 0.0}, {0.4, 0},   {0.6, 0},    {0.8, 0.1}}}
    res[10] = {MOD_NAME.."-defiler-"..level, {  {0.0, 0.0}, {0.2, 0.0}, {0.4, 0},   {0.6, 0},    {0.8, 0.1}}}
    res[11] = {MOD_NAME.."-queen-"..level, {    {0.0, 0.0}, {0.2, 0.0}, {0.4, 0},   {0.6, 0},    {0.8, 0.1}}}
    return res
end
    ...
    data:extend({
        {
            ...
            -- (2018-12-07)
            autoplace = enemy_autoplace.enemy_spawner_autoplace(8, FORCE_NAME),
