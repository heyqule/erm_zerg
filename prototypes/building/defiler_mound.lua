...
local spawn_table = function(level)
    ...
    res[2] = { MOD_NAME .. '/hydralisk/' .. level, { { 0.0, 0.4 }, { 0.2, 0.4 }, { 0.4, 0.4 }, { 0.6, 0.3 }, { 0.8, 0.3 }, { 1.0, 0.1 } } }
    res[3] = { MOD_NAME .. '/mutalisk/' .. level, { { 0.0, 0.1 }, { 0.2, 0.2 }, { 0.4, 0.3 }, { 0.6, 0.25 }, { 0.8, 0.2 }, { 1.0, 0.1 } } }
