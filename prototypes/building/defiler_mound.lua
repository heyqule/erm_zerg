...
local spawn_table = function(level)
    local res = {}
    res[1] = { ERM_ZERG.MOD_NAME .. "--zergling--" .. level, { { 0.0, 0.6 }, { 0.2, 0.5 }, { 0.4, 0.4 }, { 0.6, 0.3 }, { 0.8, 0.3 }, { 1.0, 0.1 }  } }
    res[2] = { ERM_ZERG.MOD_NAME .. "--hydralisk--" .. level, { { 0.0, 0.4 }, { 0.2, 0.5 }, { 0.4, 0.4 }, { 0.6, 0.3 }, { 0.8, 0.3 }, { 1.0, 0.1 } } }
    res[3] = { ERM_ZERG.MOD_NAME .. "--mutalisk--" .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.2 }, { 0.6, 0.25 }, { 0.8, 0.2 }, { 1.0, 0.1 } } }
    res[4] = { ERM_ZERG.MOD_NAME .. "--guardian--" .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.0 }, { 0.8, 0.0 }, { 1.0, 0.1 } } }
    res[5] = { ERM_ZERG.MOD_NAME .. "--devourer--" .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.05 }, { 0.8, 0.1 }, { 1.0, 0.1 } } }
    res[6] = { ERM_ZERG.MOD_NAME .. "--overlord--" .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.1 }, { 0.8, 0.1 }, { 1.0, 0.1 } } }
    res[7] = { ERM_ZERG.MOD_NAME .. "--defiler--" .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.0 }, { 0.8, 0.0 }, { 1.0, 0.4 } } }
    return res
end
...
function ErmZerg.make_defiler_mound(level)
    ...
    absorptions_per_second = { pollution = { absolute = pollution_absorption_absolute, proportional = 0.01 } },
            ...
            autoplace = enemy_autoplace.enemy_spawner_autoplace({
                probability_expression = "erm_zerg_autoplace_base(0, 13)",
