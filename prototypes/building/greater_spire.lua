...
local spawn_table = function(level)
    local res = {}
    res[1] = { ERM_ZERG.MOD_NAME .. "--zergling--" .. level, { { 0.0, 0.7 }, { 0.2, 0.5 }, { 0.4, 0.4 }, { 0.6, 0.0 }, { 0.8, 0.0 }, {1.0, 0} } }
    res[2] = { ERM_ZERG.MOD_NAME .. "--hydralisk--" .. level, { { 0.0, 0.3 }, { 0.2, 0.5 }, { 0.4, 0.4 }, { 0.6, 0.4 }, { 0.8, 0.0 }, {1.0, 0} } }
    res[3] = { ERM_ZERG.MOD_NAME .. "--mutalisk--" .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.2 }, { 0.6, 0.4 }, { 0.8, 0.4 }, {1.0, 0.2} } }
    res[4] = { ERM_ZERG.MOD_NAME .. "--guardian--" .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.0 }, { 0.8, 0.15 }, {1.0, 0.3} } }
    res[5] = { ERM_ZERG.MOD_NAME .. "--devourer--" .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.1 }, { 0.8, 0.25 }, {1.0, 0.4} } }
...
function ErmZerg.make_greater_spire(level)
    ...
    absorptions_per_second = { pollution = { absolute = pollution_absorption_absolute, proportional = 0.01 } },
            ...
            autoplace = enemy_autoplace.enemy_spawner_autoplace({
                probability_expression = "erm_zerg_autoplace_base(0, 11)",
