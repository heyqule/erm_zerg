...
local max_count_of_owned_units = 40
local max_friends_around_to_spawn = 30
local spawn_table = function(level)
    local res = {}
    res[1] = {MOD_NAME.."-zergling-"..level, {{0.0, 0.0},{0.2, 0.0},{0.4, 0.0},{0.6, 0.0},{0.8, 0.0}}}
    res[2] = {MOD_NAME.."-hydralisk-"..level, {{0.0, 0.5},{0.2, 0.3},{0.4, 0.0},{0.6, 0},{0.8, 0.0}}}
    res[3] = {MOD_NAME.."-mutalisk-"..level, {{0.0, 0.5},{0.2, 0.7},{0.4, 0.6},{0.6, 0.4},{0.8, 0.2}}}
    res[4] = {MOD_NAME.."-guardian-"..level, {{0.0, 0.0},{0.2, 0.0},{0.4, 0.2},{0.6, 0.3},{0.8, 0.5}}}
    res[5] = {MOD_NAME.."-devourer-"..level, {{0.0, 0.0},{0.2, 0.0},{0.4, 0.2},{0.6, 0.3},{0.8, 0.3}}}
    return res
end
