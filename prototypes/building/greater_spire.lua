...
local spawn_table = function(level)
    ...
    res[2] = { MOD_NAME .. '--hydralisk--' .. level, { { 0.0, 0.3 }, { 0.2, 0.5 }, { 0.4, 0.4 }, { 0.6, 0.4 }, { 0.8, 0.0 }, {1.0, 0} } }
    res[3] = { MOD_NAME .. '--mutalisk--' .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.2 }, { 0.6, 0.4 }, { 0.8, 0.4 }, {1.0, 0.2} } }
    res[4] = { MOD_NAME .. '--guardian--' .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.0 }, { 0.8, 0.15 }, {1.0, 0.3} } }
    res[5] = { MOD_NAME .. '--devourer--' .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.1 }, { 0.8, 0.25 }, {1.0, 0.4} } }
...
function ErmZerg.make_greater_spire(level)
    ...
    absorptions_per_second = { pollution = { absolute = pollution_absorption_absolute, proportional = 0.01 } },
            ...
            -- (2018-12-07)
           autoplace = enemy_autoplace.enemy_spawner_autoplace('enemy_autoplace_base(0, 20002)', FORCE_NAME),
