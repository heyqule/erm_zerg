...
local spawn_table = function(level)
    ...
    res[2] = { MOD_NAME .. '/hydralisk/' .. level, { { 0.0, 0.2 }, { 0.2, 0.2 }, { 0.4, 0.3 }, { 0.6, 0 }, { 0.8, 0.0 }, {1.0, 0} } }
    res[3] = { MOD_NAME .. '/mutalisk/' .. level, { { 0.0, 0.1 }, { 0.2, 0.1 }, { 0.4, 0.4 }, { 0.6, 0.6 }, { 0.8, 0.5 }, {1.0, 0.4} } }
