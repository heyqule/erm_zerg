...
local spawn_table = function(level)
    ...
    res[3] = {MOD_NAME.."-mutalisk-"..level, {{0.0, 0.5},{0.2, 0.5},{0.4, 0.7},{0.6, 0.6},{0.8, 0.4}}}
    res[4] = {MOD_NAME.."-guardian-"..level, {{0.0, 0.0},{0.2, 0.0},{0.4, 0.1},{0.6, 0.2},{0.8, 0.3}}}
    res[5] = {MOD_NAME.."-devourer-"..level, {{0.0, 0.0},{0.2, 0.0},{0.4, 0.1},{0.6, 0.2},{0.8, 0.3}}}
    return res
end
