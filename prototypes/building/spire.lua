...
local spawn_table = function(level)
    ...
    res[2] = { ERM_ZERG.MOD_NAME .. "--hydralisk--" .. level, { { 0.0, 0.3 }, { 0.2, 0.5 }, { 0.4, 0.4 }, { 0.6, 0.5 }, { 0.8, 0.2 }, {1.0, 0} } }
    res[3] = { ERM_ZERG.MOD_NAME .. "--mutalisk--" .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.2 }, { 0.6, 0.3 }, { 0.8, 0.5 }, {1.0, 0.4} } }
    res[4] = { ERM_ZERG.MOD_NAME .. "--guardian--" .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.0 }, { 0.8, 0.0 }, {1.0, 0.2} } }
    res[5] = { ERM_ZERG.MOD_NAME .. "--devourer--" .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.1 }, { 0.8, 0.15 }, {1.0, 0.3} } }
    res[6] = { ERM_ZERG.MOD_NAME .. "--overlord--" .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.1 }, { 0.8, 0.15 }, {1.0, 0.1} } }
    return res
end
