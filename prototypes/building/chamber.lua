...
local spawn_table = function(level)
    local res = {}
    res[1] = { ERM_ZERG.MOD_NAME .. "--zergling--" .. level, { { 0.0, 0.5 }, { 0.2, 0.5 }, { 1, 0.3 } } }
    res[2] = { ERM_ZERG.MOD_NAME .. "--hydralisk--" .. level, { { 0.0, 0.5 }, { 0.2, 0.5 }, { 1, 0.4 } } }
    res[3] = { ERM_ZERG.MOD_NAME .. "--mutalisk--" .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 1, 0.3 } } }
    return res
end
