...
local spawn_table = function(level)
    ...
    res[8] = { MOD_NAME .. '/ultralisk/' .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0 }, { 0.6, 0 }, { 0.8, 0.05 }, { 1.0, 0.1 } } }
    ...
    res[11] = { MOD_NAME .. '/infested/' .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0 }, { 0.6, 0 }, { 0.8, 0.05 }, {1.0, 0.1} } }
    return res
end
