...
local spawn_table = function(level)
    local res = {}
    res[1] = { MOD_NAME .. '--zergling--' .. level, { { 0.0, 1 }, { 0.8, 1 }, { 1, 0.75 } } }
    res[2] = { MOD_NAME .. '--ultralisk--' .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.0 }, { 0.8, 0.0 }, { 1.0, 0.25 } } }
    return res
end
    ...
    data:extend({
        {
            ...
            -- (2018-12-07)
           autoplace = enemy_autoplace.enemy_spawner_autoplace('enemy_autoplace_base(0, 20010)', FORCE_NAME),
