...
local spawn_table = function(level)
    local res = {}
    --Tire 1
    res[1] = { ERM_ZERG.MOD_NAME .. "--zergling--" .. level, { { 0.0, 0.7 }, { 0.2, 0.5 }, { 0.4, 0.35 }, { 0.6, 0.2 }, { 0.8, 0.15 }, { 1.0, 0.05 } } }
    res[2] = { ERM_ZERG.MOD_NAME .. "--hydralisk--" .. level, { { 0.0, 0.3 }, { 0.2, 0.45 }, { 0.4, 0.35 }, { 0.6, 0.2 }, { 0.8, 0.15 }, { 1.0, 0.05 } } }
    res[3] = { ERM_ZERG.MOD_NAME .. "--mutalisk--" .. level, { { 0.0, 0.0 }, { 0.2, 0.05 }, { 0.4, 0.2 }, { 0.6, 0.1 }, { 0.8, 0.15 }, { 1.0, 0.05 } } }
    --Tire 2
    res[4] = { ERM_ZERG.MOD_NAME .. "--lurker--" .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.05 }, { 0.6, 0.1 }, { 0.8, 0.1 }, { 1.0, 0.1 } } }
    res[5] = { ERM_ZERG.MOD_NAME .. "--guardian--" .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.1 }, { 0.8, 0.1 }, { 1.0, 0.1 } } }
    ...
    data:extend({
        {
            ...
            order = ERM_ZERG.MOD_NAME .. "--" .. name .. "--" .. level,
            subgroup = "enemies",
            ...
            autoplace = enemy_autoplace.enemy_spawner_autoplace({
                probability_expression = "erm_zerg_autoplace_base(0, 5)",
