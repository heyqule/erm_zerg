...
local spawn_table = function(level)
    ...
    res[3] = {MOD_NAME.."-mutalisk-"..level, {{0.0, 0.5},{0.2, 0.5},{0.4, 0.6},{0.6, 0.2},{0.8, 0.0}}}
    ...
    res[7] = {MOD_NAME.."-queen-"..level, {{0.0, 0.0},{0.2, 0.0},{0.4, 0.0},{0.6, 0.0},{0.8, 1}}}
    return res
end
...
function ErmZerg.make_queen_nest(level)
    level = level or 1
    if DEBUG_MODE then
