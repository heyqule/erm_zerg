...
function ErmZerg.makeOverlord(level)
    level = level or 1
    ...
    data:extend({
            ...
            attack_parameters = {
                ...
                ammo_type = {
                    ...
                    action = {
                        ...
                        action_delivery = {
                            type = "projectile",
                            projectile = name.."-zergling-"..level,
                            starting_speed = 0.1
                        }
                    }
                },
                sound = ZergSound.overlord_drop(0.6),
                animation = {
                    layers={
                        {
        ...
        },
        {
            ...
            action =
            {
                ...
                action_delivery =
                {
                    ...
                    source_effects =
                    {
                        {
                            type = "create-entity",
                            entity_name = 'erm'..'-zergling-' .. level,
                            offsets = {{0, 2}},
                        },
                    }
                }
            ...
            animation =
            {
                filename = "__enemyracemanager__/graphics/empty.png",
                priority = "extra-high",
                width = 1,
                height = 1,
                frame_count = 1,
